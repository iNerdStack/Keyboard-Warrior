      ...
      <div class="m-6 md:m-10">
        ...
        <div class="flex flex-col md:flex-row mt-8">
          <div class="grid md:grid-cols-3 grid-cols-1 gap-4 w-full md:w-4/6">
            <div
              v-for="item in analytics.scores"
              class="bg-white hover:bg-primary hover:!text-white p-4 rounded-lg"
            >
              <div class="flex flex-row justify-between">
                ...
                <div>
                  <Icon name="mdi:star" class="text-[15px] text-[#ffc300]" />
                </div>
              </div>

              <div class="flex justify-center text-center my-12 flex-col">
                <span class="text-4xl">{{ item.count }} </span>
                <span class="text-gray-500 hover:text-white text-sm">
                  {{ item.subtitle }}</span
                >
              </div>
              ...
              <div
                ...
                class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700 my-4"
              >
                <div
                  class="h-2.5 rounded-full"
                  :style="`width: ${item.count}; background-color: ${
                    item.progressValue <= 50
                      ? '#dc2626'
          ...
          <div class="md:px-4 mt-4 md:mt-0 grid grid-cols-1 w-full md:w-2/6">
            <div
              class="bg-white hover:bg-primary hover:text-white p-5 rounded-lg"
            >
              <div class="flex flex-row justify-between">
              ...
              <div
                class="mt-3 flex flex-row justify-between font-semibold"
                v-for="item in analytics.bestTime"
              >
        ...
        <div class="mt-5 flex flex-col text-center md:text-left">
          <span class="my-6 text-gray-500 font-bold text-md md:text-lg"
            >Record for your last 50 Games</span
          >
...
const completedGamesList: any = ref(useCompletedGamesList());
</script>
